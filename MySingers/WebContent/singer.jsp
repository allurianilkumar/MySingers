  ...
  <body>
 	<%@include file="include/nav_bar.jsp" %>
      <div class="jumbotron">
        ...
        <div class="col-md-2"><div class="alert alert-info" role="alert">Join Events&nbsp;&nbsp;<span>---->></span></div></div>
        <div class="col-md-2"><div class="alert alert-success" role="alert">winner</div></div>
        </div>        
      </div>
